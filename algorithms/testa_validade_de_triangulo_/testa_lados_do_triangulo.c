...
//exercicio 5
int aluno(float notaApol, float provaObjetiva, float provaDiscursiva,float atividadePratica) {
...
//laco da escolha das opcoes
	do {
		...
		printf("#####   ATIVIDADE PRATICA 2018 C - PROFESSOR VINICIOS P. BORIN                                   ####\n");
			printf("\n\n");
		printf(":##################################    MENU     #####################################################:  ");
		printf("\n");
		...
		printf("\n");
		printf("#)Digite (5) e tecle ENTER. Entra EXERCICIO 5  MEDIA DE ALUNO : ");
		printf("\n");
		...
		if (escolha == '5' || escolha == '5') {
			...
			printf("####     prova discursiva e atividade pratica), seguindo os crit�rios da ;                   #####\n");
			...
			teste = aluno(notaApol, provaObjetiva, provaDiscursiva, atividadePratica);
